...
import type { CSSProperties, PropsWithRef } from "react";
import MarkdownPreview from "../MdPreview";
import type { MarkdownPreviewProps } from "../MdPreview";
...
const InternalMDEditor = (
  props: MDEditorProps,
  ref?:
    | ((instance: ContextStore) => void)
    | React.RefObject<ContextStore>
    | null
) => {
  const {
